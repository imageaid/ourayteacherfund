...
class ApplicationsTest < ApplicationSystemTestCase
  ...
  test "should create application" do
    ...
    fill_in "Amount requested", with: @application.amount_requested
    fill_in "Other purpose", with: @application.other_purpose
    fill_in "Purpose", with: @application.purpose
    fill_in "School year", with: @application.school_year
